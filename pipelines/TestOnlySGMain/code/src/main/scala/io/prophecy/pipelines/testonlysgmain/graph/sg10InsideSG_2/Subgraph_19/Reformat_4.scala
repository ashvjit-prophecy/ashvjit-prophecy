package io.prophecy.pipelines.testonlysgmain.graph.sg10InsideSG_2.Subgraph_19
...
import io.prophecy.pipelines.testonlysgmain.graph.sg10InsideSG_2.Subgraph_19.config.Context
