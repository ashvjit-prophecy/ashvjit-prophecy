package io.prophecy.pipelines.testonlysgmain.graph.sg10InsideSG_6.Subgraph_19
...
import io.prophecy.pipelines.testonlysgmain.graph.sg10InsideSG_6.Subgraph_19.config.Context
