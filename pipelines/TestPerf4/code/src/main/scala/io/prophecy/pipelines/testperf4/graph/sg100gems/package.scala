...
import io.prophecy.pipelines.testperf4.graph.sg100gems.config._
...
package object sg100gems {
  ...
  def apply(context: Context, in0: DataFrame): Subgraph8 = {
    ...
    val df_Limit_1_2           = Limit_1_2(context,           df_SchemaTransform_1_2).cache()
    ...
    val df_SchemaTransform_1_1_1 =
      SchemaTransform_1_1_1(context, df_SQLStatement_1_2).cache()
    val df_Limit_1_1_1 = Limit_1_1_1(context, df_SchemaTransform_1_1_1)
    val df_Repartition_1_1_1 =
      Repartition_1_1_1(context, df_Limit_1_1_1).cache()
