...
object Main {
  ...
  def apply(context: Context): Unit = {
    ...
    Lookup_1(context, df_src_emr_s3_source_1)
    ...
    val df_Filter_3           = Filter_3(context,           df_src_emr_s3_source)
    ...
    val df_Reformat_3_2_1 = if (context.config.c_string == "will.i.am") {
      ...
      null
    val df_Script_3   = Script_3(context,   df_src_emr_s3_source_2)
    ...
    val df_Script_3_3   = Script_3_3(context,   df_SQLStatement_1)
    val df_Script_3_1_1 = Script_3_1_1(context, df_Script_3_3)
    val df_Reformat_1_1_4_1_1_4_1_7 =
      Reformat_1_1_4_1_1_4_1_7(context, df_Script_3_1_1)
    ...
    val df_Script_3_2 = Script_3_2(context, df_Script_3_1)
  }
