package io.prophecy.pipelines.livysmallpipeline.graph.`210Gems_10kLOC`.Subgraph_2_1_2
...
import io.prophecy.pipelines.livysmallpipeline.graph.`210Gems_10kLOC`.Subgraph_2_1_2.config.Context
