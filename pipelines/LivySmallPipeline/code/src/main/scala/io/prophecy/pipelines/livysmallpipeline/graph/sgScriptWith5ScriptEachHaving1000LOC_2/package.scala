...
import io.prophecy.pipelines.livysmallpipeline.graph.sgScriptWith5ScriptEachHaving1000LOC_2.config._
...
import java.time._
package object sgScriptWith5ScriptEachHaving1000LOC_2 {
