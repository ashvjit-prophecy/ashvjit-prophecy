package io.prophecy.pipelines.testperfmoresgraphs.graph.sg10InsideSG.Subgraph_17
...
import io.prophecy.pipelines.testperfmoresgraphs.graph.sg10InsideSG.Subgraph_17.config.Context
